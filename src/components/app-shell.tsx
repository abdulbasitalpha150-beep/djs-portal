  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
      ...
      <aside className="hidden w-60 shrink-0 flex-col border-r border-sidebar-border bg-sidebar lg:flex">
        <SidebarBrand />
        <SidebarNav grouped={grouped} pathname={pathname} unreadCount={unreadCount} />
      </aside>
                  ...
                  <li key={item.to}>
                    ...
                    >
                      ...
                      {item.to === "/notifications" && unreadCount > 0 && (
                        <span className="ml-auto grid size-4 shrink-0 place-items-center rounded-full bg-primary text-[10px] font-semibold text-primary-foreground">
